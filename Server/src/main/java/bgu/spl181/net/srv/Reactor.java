...
public class Reactor<T> implements Server<T> {
    ...
    private void handleAccept(ServerSocketChannel serverChan, Selector selector) throws IOException {
        ...
        // gets the Protocol for the Connection
        ...
        // creates a connection Id and adds it to the Connections
        currentId++;
        connections.addConnectHandler((ConnectionHandler) handler, currentId);
